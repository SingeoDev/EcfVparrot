window.onload = () => {
    ...
    function addValue() {
      form = document.getElementById('contactAboutForm') // contact = le formulaire, firstName = le champ du formulaire
      firstName = document.getElementById('contact_about_firstName') // contact = le formulaire, firstName = le champ du formulaire
      lastName = document.getElementById('contact_about_lastName') // contact = le formulaire, lastName = le champ du formulaire
      email = document.getElementById('contact_about_email') // contact = le formulaire, email = le champ du formulaire
      phone = document.getElementById('contact_about_phone') // contact = le formulaire, phone = le champ du formulaire 
      message = document.getElementById('contact_about_message') // contact = le formulaire, message = le champ du formulaire
  
      // begin submit form

      form.addEventListener('submit', function(event) {
        event.preventDefault()
        requestAsyncAwaitAbout()   
      })
...
// restartForm finished
    ...
    // begin requestAsyncAwaitAbout

    async function requestAsyncAwaitAbout() {
      try {
  ...
  // requestAsyncAwaitAbout finished
}
